...
- **Víctor**: consultó la venta, actuó manualmente en las plataformas, preparó el envío y resolvió las excepciones
- **SANIA**: leyó correos, relacionó hechos, reservó stock, registró importes y generó avisos sin escribir en las plataformas

- "venta detectada": operación comunicada por el primer correo reconocido de Wallapop o Vinted; todavía no equivale a venta cerrada
- "unidad exacta": unidad física identificada por la referencia alfanumérica de tres caracteres que aparece como sufijo del título del anuncio vendido
- "pendiente de conciliación": venta que SANIA no puede asignar con seguridad porque falta la referencia, no coincide, está alterada o la unidad exacta no está disponible
- "FIFO": posible criterio de sustitución no confirmado con un caso real; no se ejecuta automáticamente en el MVP
...
### El correo inicial de Vinted reservó la unidad exacta [con la app]
...
### El correo inicial de Wallapop reservó la unidad exacta [con la app]
...
### SANIA distinguió la entrega del cierre económico [con la app]
...
- En una venta ordinaria, el correo inició la reserva; Víctor consultó manualmente conversación o instrucciones, obtuvo transportista y QR, localizó y preparó la unidad y esperó el hecho final de la plataforma. [D-LIVE-001, D-LIVE-003, T01-Q01, T02-Q01, T05-Q01, T05-Q04]
- Un extra o lote acordado se documentó modificando el anuncio antes de aceptar la oferta; falta un caso real que defina cómo relacionar varias unidades o productos con una sola venta. [D-LIVE-002, G-LIVE-010, T01-Q06, T01-Q07]
- Cuando una última unidad estaba anunciada en Wallapop y Vinted, el primer correo de venta la reservó y SANIA avisó para retirar manualmente el anuncio de la otra plataforma; dos correos simultáneos siguen sin regla de conciliación. [D-LIVE-001, D-LIVE-008, D-LIVE-009, G-LIVE-008, T01-Q08, T04-Q04, T10-Q02]
- Tres correos reales de Vinted con TX-COMPLETE incluyeron número de transacción, fecha, título, precio de artículo, envío y transferencia al saldo; dos ventas pudieron compartir el mismo título base con importes distintos. [D-LIVE-004, G-LIVE-011, T06-Q01, X-LIVE-010]
- El correo Wallapop Envíos: tu paquete ha sido entregado :) acreditó la entrega de una venta de 50,00 €, pero indicó que el dinero solo estaría disponible tras el OK del comprador. [D-LIVE-005, G-LIVE-012, T06-Q02]
- El historial del monedero mostró una entrada Venta de 50,00 € y también retiradas, recargas y reembolsos; asociar el hecho final exige distinguir el tipo de movimiento y una fuente permitida todavía no definida. [D-LIVE-005, T06-Q02, T09-Q02, X-LIVE-005]

## 5. Reglas de negocio

### G-LIVE-001: Cada hecho externo se aplicó una sola vez

La idempotencia evitó duplicar venta, reserva o movimiento. Es una protección confirmada por el contexto, aunque T02-Q05 no dispone todavía de un caso real de correo duplicado, tardío o desordenado.

### G-LIVE-005: Cada anuncio representó una unidad

D-LIVE-007 hizo que el anuncio identificara una sola unidad física; los extras o lotes de E-LIVE-002 requieren una relación adicional todavía no definida.

### G-LIVE-006: La referencia pública vinculó correo y unidad

Según D-LIVE-006 y X-LIVE-001, el título terminó con una referencia alfanumérica de tres caracteres. El título base repetido no fue suficiente por sí solo, como muestra X-LIVE-010.

### G-LIVE-007: Se reservó la unidad exacta, sin FIFO confirmado

La nueva referencia permitió reservar la unidad del anuncio. T01-Q11 no aporta un caso real de FIFO y por ello una unidad exacta no disponible abrió conciliación en vez de activar una sustitución automática.

### G-LIVE-008: El primer correo reconocido reservó una unidad compartida

D-LIVE-001 y D-LIVE-009 dispusieron la reserva desde el primer correo y el aviso de retirada manual del otro anuncio; T10-Q02 mantiene abierta la colisión de correos casi simultáneos.

### G-LIVE-009: Las acciones de plataforma fueron humanas

D-LIVE-010 y X-LIVE-003 impiden que SANIA cree, modifique, retire o reactive anuncios; tampoco se autorizó lectura web por X-LIVE-007.

### G-LIVE-010: La descripción final determinó lo enviado

D-LIVE-002 exige incorporar manualmente al anuncio cualquier extra acordado antes de cerrar la oferta.

### G-LIVE-011: Vinted cerró con TX-COMPLETE

D-LIVE-004 permite cerrar idempotentemente por número de transacción cuando llega el correo La transacción se ha completado; las variantes de idioma o plantilla siguen pendientes.

### G-LIVE-012: La entrega de Wallapop no cerró la venta

D-LIVE-005 mantiene abierta la venta tras el correo de entrega. X-LIVE-005 deja bloqueado cómo incorporar a SANIA el movimiento final del monedero.

### D-LIVE-015: La URL no fue una clave obligatoria

La referencia del título identificó la unidad. Por X-LIVE-002, una URL se conservó solo si estaba disponible para navegación o instrucciones, sin depender de ella para reservar.

### D-LIVE-030: El importe se registró sin cerrar el beneficio

El precio comunicado se guardó como importe de venta; no se calculó aquí un beneficio definitivo porque faltan costes, comisiones, impuestos y reglas de reparto.
