...
- **Víctor**: consultó manualmente el tracking, esperó cuando había una incidencia y, si no cambiaba, contactó al transportista e informó al comprador

## 3. El proceso (flujos)

La versión gráfica vive en el visor local del paquete (visor/servir.py).

### SANIA actualizó el trayecto demostrado por correos reconocidos [con la app]
...
### Víctor atendió manualmente un tracking sin cambios [con la app]
...
- Después de la entrega al transportista, Víctor suele avisar al comprador, espera las evidencias y consulta manualmente el tracking cuando falta una confirmación; en Wallapop el tracking puede ser difícil de identificar. [E-LIVE-001, T05-Q04, T06-Q03]
- El correo real de Wallapop informó de que el paquete fue entregado, pero el dinero seguía pendiente del OK del comprador. [E-LIVE-008, T06-Q02]

## 5. Reglas de negocio

### G-LIVE-001: Cada hecho logístico se aplica una sola vez

Un correo repetido o reprocesado no duplica estados, movimientos ni avisos.

### G-LIVE-012: Entregado en Wallapop no significa cerrado

El correo de paquete entregado prueba la entrega logística, pero la venta y el ingreso continúan abiertos.
