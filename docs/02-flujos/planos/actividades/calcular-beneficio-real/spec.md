...
### SANIA determinó si el beneficio podía considerarse definitivo [con la app · origen: usuario]
...
- Los cierres Vinted aportaron precio del artículo, envío y transferencia al saldo, pero no comisiones, embalaje, impuestos ni el resto de costes necesarios para validar un beneficio real. [Migración: referencias históricas: E-LIVE-007, T06-Q07, T06-Q10] [G-9]
- La entrega de Wallapop por 50,00 € no cerró la venta; por ello tampoco pudo convertir el ingreso provisional en beneficio definitivo. [Migración: referencias históricas: E-LIVE-008, T06-Q02] [G-11]

## 5. Reglas de negocio

### G-9: El precio guardado no es beneficio

El importe de venta se conserva y las finanzas lo usarán después; no se cierra el beneficio hasta disponer de costes reales. [Migración: identificador histórico D-LIVE-030]

### G-10: Pricing por dos márgenes queda en evolución

Precio de publicación y mínimo se derivarán del coste y dos márgenes cuando se defina la fórmula; el 25 % fue un ejemplo, no un valor fijado para el MVP. [Migración: identificador histórico D-LIVE-026; referencias históricas: G-LIVE-019, X-LIVE-009, T03-Q06]

### G-11: Wallapop bloquea su beneficio mientras no cierre

Sin una fuente final del monedero, SANIA no puede cerrar la venta ni declarar definitivo su resultado. [Migración: identificador histórico X-LIVE-005]
