...
| producto y variante | nombre y código interno, variante relevante, clasificación aprendida Stock para venta o Compra personal y su historial de corrección, datos editoriales vigentes para anuncios, enlaces y vendedores de compra separados de la identidad del producto | correos de AliExpress y datos confirmados por Víctor |
...
- Habla con **Telegram**: pedir comprobaciones físicas, agrupar propuestas de publicación con una confirmación por publicación y solicitud posterior del enlace, y avisar de tickets, incidencias, referencias anómalas, duplicados y conflictos de venta que debe resolver Víctor; las incidencias se recuerdan diariamente por defecto y admiten una frecuencia persistente configurable
...
| Qué puede hacer | confirmar un hecho físico · resolver una decisión estructurada · pedir las imágenes de una tarea de publicación · confirmar Ya he publicado para una publicación y aportar su enlace · aplazar o cancelar una sugerencia de publicación · abrir o completar un ticket de revisión o una incidencia · cambiar la frecuencia o pausar el escalado de una incidencia · reactivar una comprobación pública pausada por seguridad · consultar el estado de una tarea |
...
|  | confirmar un hecho físico | resolver una decisión estructurada | pedir las imágenes de una tarea de publicación | confirmar Ya he publicado para una publicación y aportar su enlace | aplazar o cancelar una sugerencia de publicación | abrir o completar un ticket de revisión o una incidencia | cambiar la frecuencia o pausar el escalado de una incidencia | reactivar una comprobación pública pausada por seguridad | consultar el estado de una tarea | consultar operaciones | revisar excepciones | solicitar correcciones admitidas por el flujo y explicar el motivo | consultar resultados |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Víctor | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
|---|---|---|---|
| Víctor | una confirmación, decisión o excepción necesitó su intervención | Telegram | cuando un hecho concreto requirió intervención; las incidencias repiten diariamente por defecto o con el intervalo persistente elegido, y las demás cadencias siguen pendientes por actividad |
