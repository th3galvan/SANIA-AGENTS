...
- **Víctor**: revisó el anuncio y la conversación, localizó con ojos y manos la unidad, reunió el contenido y embaló el paquete
...
- "unidad reservada": unidad física identificada por la referencia alfanumérica de tres caracteres del título y apartada desde el primer correo de venta

## 3. El proceso (flujos)

La versión gráfica vive en el visor local del paquete (visor/servir.py).

### Víctor preparó el contenido documentado en el anuncio final [con la app]
...
- En una venta ordinaria, Víctor revisa anuncio y conversación, localiza la unidad con ojos y manos y prepara físicamente el paquete antes de obtener y presentar el QR. [E-LIVE-001, T01-Q01, T05-Q01]
- Cuando se acuerda un extra, Víctor pide una oferta que lo incluya y modifica el anuncio para que la descripción final documente exactamente lo enviado. [E-LIVE-002, T01-Q07, T05-Q02]

## 5. Reglas de negocio

### G-LIVE-010: El paquete coincide con el anuncio final

La descripción final del anuncio, no una conversación aislada, documenta el contenido vendido; un extra solo se prepara después de quedar reflejado en el anuncio.

### D-LIVE-003: El material de envío se obtiene manualmente

Víctor consulta manualmente desde el correo o la conversación las instrucciones, el transportista y el QR; SANIA no debe afirmar que los obtiene de la plataforma.
