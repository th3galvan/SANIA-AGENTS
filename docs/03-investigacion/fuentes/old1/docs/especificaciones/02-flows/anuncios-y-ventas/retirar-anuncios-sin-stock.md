...
- **Víctor**: retiró manualmente el anuncio alternativo; no se definió cómo comunica o acredita el resultado ante SANIA
- **SANIA**: reservó la unidad, creó la tarea y mantuvo el pendiente sin actuar en la plataforma
...
### Víctor retiró manualmente el anuncio alternativo [con la app]
...
- Una última unidad estuvo anunciada a la vez en Wallapop y Vinted. El primer correo de venta la reservó y Víctor eliminó manualmente el otro anuncio; la colisión de dos correos simultáneos no quedó resuelta. [E-LIVE-003, D-LIVE-001, D-LIVE-008, D-LIVE-009, G-LIVE-008, T01-Q08, T04-Q04, T10-Q02]

## 5. Reglas de negocio

### G-LIVE-005: Cada anuncio representó una unidad

D-LIVE-007 estableció una relación anuncio-unidad. Con varias unidades, Wallapop y Vinted apuntan normalmente a referencias distintas; la retirada de este flujo se dirige al anuncio alternativo de la unidad ya reservada.

### G-LIVE-008: El primer correo ganó para una unidad compartida

D-LIVE-001 y D-LIVE-009 dispusieron reservar desde el primer correo reconocido y solicitar inmediatamente la retirada manual del anuncio de la otra plataforma; T10-Q02 mantiene pendiente la concurrencia casi simultánea.

### G-LIVE-009: La retirada fue humana

D-LIVE-010 y X-LIVE-003 prohíben que SANIA elimine, pause, edite o reactive anuncios dentro de Wallapop o Vinted.

### D-LIVE-015: La URL no fue obligatoria

La tarea se vinculó por unidad, plataforma y referencia del título. X-LIVE-002 deja la URL como dato opcional para navegación o auditoría, no como requisito.
